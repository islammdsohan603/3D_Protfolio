...
export default function Projects() {
  ...
  return (
    <section
      id="projects"
      ref={containerRef}
      className="relative py-12 md:py-20 bg-slate-100 dark:bg-[#09090b] transition-colors duration-300"
    ...
    >
      ...
      <div className="w-11/12 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        {/* Sheryians Pinned Stacking Track */}
        <div id="projects-deck" className="relative pb-16">
        ...
        <div className="flex items-center justify-between text-[11px] font-mono text-slate-500 dark:text-zinc-500 pt-10 border-t border-slate-300 dark:border-zinc-900">
