...
export default function Hero() {
  ...
  return (
    <section id="hero" className="relative min-h-screen flex items-center justify-center pt-28 pb-16 sm:py-20 md:py-24 lg:py-32 overflow-x-clip">
        ...
        <ScrollRevealStagger className="flex-1 text-center lg:text-left space-y-6 w-full">
          ...
          <ScrollRevealItem>
            <div className="pt-8 grid grid-cols-3 gap-4 border-t border-white/[0.08] max-w-lg mx-auto lg:mx-0">
              <div>
                <div className="text-xl sm:text-3xl font-extrabold font-mono text-cyan-400">100%</div>
                <div className="text-[10px] sm:text-xs text-zinc-400 uppercase tracking-wider">Satisfaction Rate</div>
              </div>
              <div>
                <div className="text-xl sm:text-3xl font-extrabold font-mono text-indigo-400">Batch 13</div>
                <div className="text-[10px] sm:text-xs text-zinc-400 uppercase tracking-wider">Blackbelt Rank</div>
              </div>
              <div>
                <div className="text-xl sm:text-3xl font-extrabold font-mono text-emerald-400">20+</div>
                <div className="text-[10px] sm:text-xs text-zinc-400 uppercase tracking-wider">Live Projects</div>
              </div>
            </div>
          </ScrollRevealItem>
        </ScrollRevealStagger>
