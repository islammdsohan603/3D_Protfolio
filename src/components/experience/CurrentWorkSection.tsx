    ...
    <section id="experience" className="relative py-5 md:py-10 lg:py-16 z-10 overflow-x-clip transition-colors duration-300">
      ...
      <div className="w-11/12 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <ScrollReveal className="text-center space-y-4 mb-12 sm:mb-16">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-indigo-500/10 border border-indigo-500/30 text-indigo-600 dark:text-indigo-400 text-xs font-mono tracking-wider shadow-[0_0_15px_rgba(99,102,241,0.2)]">
        ...
        <ScrollReveal direction="up" delay={0.1} className="relative rounded-3xl bg-white/90 dark:bg-zinc-900/60 border border-slate-200/90 dark:border-zinc-800/90 backdrop-blur-2xl p-6 sm:p-10 shadow-xl dark:shadow-2xl overflow-hidden group transition-colors duration-300">
          ...
          <div className="flex flex-wrap items-center justify-between gap-4 mb-8 pb-6 border-b border-slate-200 dark:border-white/10 relative z-10">
            <div className="flex items-center gap-4">
              {/* Company Logo Badge */}
              <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-cyan-500/20 via-indigo-500/20 to-purple-500/20 border border-cyan-500/40 flex items-center justify-center text-cyan-600 dark:text-cyan-300 shadow-[0_0_20px_rgba(0,242,254,0.25)] shrink-0">
              ...
              <div>
                <div className="flex flex-wrap items-center gap-3">
                  ...
                  <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-emerald-500/10 border border-emerald-500/30 text-emerald-600 dark:text-emerald-400 text-xs font-mono font-semibold tracking-wider">
                    <span className="w-2 h-2 rounded-full bg-emerald-500 dark:bg-emerald-400 animate-ping" />
                    <span>BUILDING IN PRODUCTION</span>
                  </span>
                </div>

                <div className="flex flex-wrap items-center gap-4 text-xs font-mono text-slate-500 dark:text-zinc-400 mt-1">
                  ...
                  <span className="flex items-center gap-1 text-slate-500 dark:text-zinc-400">
                    <Calendar className="w-3.5 h-3.5 text-slate-400 dark:text-zinc-500" /> Active Role (2026)
                  </span>
                  <span className="flex items-center gap-1 text-slate-500 dark:text-zinc-400">
                    <MapPin className="w-3.5 h-3.5 text-slate-400 dark:text-zinc-500" /> Remote / Production Team
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2 px-4 py-2 rounded-xl bg-slate-100 dark:bg-slate-950/80 border border-slate-200 dark:border-white/10 text-xs font-mono text-slate-700 dark:text-zinc-300 shadow-xs">
              <Globe className="w-4 h-4 text-cyan-600 dark:text-cyan-400" />
              <span>FLAGSHIP: <strong className="text-slate-900 dark:text-white">News & Media Portal</strong></span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-start relative z-10">
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                <div className="p-3.5 rounded-2xl bg-slate-50 dark:bg-slate-950/70 border border-slate-200/80 dark:border-white/5 flex flex-col justify-between shadow-xs">
                  <div className="flex items-center gap-2 text-cyan-600 dark:text-cyan-400 text-xs font-mono font-semibold">
                    <Zap className="w-4 h-4" />
                    <span>HYBRID ARCH</span>
                  </div>
                  <div className="text-sm font-bold text-slate-900 dark:text-white mt-1">SSR & ISR Pipelines</div>
                  <div className="text-[11px] text-slate-500 dark:text-zinc-400 font-mono mt-0.5">Sub-200ms page loads</div>
                </div>

                <div className="p-3.5 rounded-2xl bg-slate-50 dark:bg-slate-950/70 border border-slate-200/80 dark:border-white/5 flex flex-col justify-between shadow-xs">
                  <div className="flex items-center gap-2 text-purple-600 dark:text-purple-400 text-xs font-mono font-semibold">
                    <Lock className="w-4 h-4" />
                    <span>SECURITY</span>
                  </div>
                  <div className="text-sm font-bold text-slate-900 dark:text-white mt-1">Role-Based ACL</div>
                  <div className="text-[11px] text-slate-500 dark:text-zinc-400 font-mono mt-0.5">Admin, Editor, Author</div>
                </div>
                ...
                <div className="p-3.5 rounded-2xl bg-slate-50 dark:bg-slate-950/70 border border-slate-200/80 dark:border-white/5 flex flex-col justify-between shadow-xs">
                  ...
                  <div className="text-sm font-bold text-slate-900 dark:text-white mt-1">Dynamic SEO Engine</div>
                  <div className="text-[11px] text-slate-500 dark:text-zinc-400 font-mono mt-0.5">Breaking news indexing</div>
                </div>
              </div>

              {/* Bulleted Impact Points */}
              <div className="space-y-3.5 pt-2">
                <h4 className="text-xs font-mono uppercase tracking-wider text-slate-500 dark:text-zinc-400 flex items-center gap-2 font-bold">
                  <Layers className="w-4 h-4 text-cyan-600 dark:text-cyan-400" />
                  <span>KEY RESPONSIBILITIES & ENGINEERING IMPACT</span>
                </h4>

                <div className="space-y-3">
                  <div className="flex items-start gap-3 p-3.5 rounded-2xl bg-slate-50 dark:bg-slate-950/40 border border-slate-200/80 dark:border-white/5 hover:border-cyan-500/30 transition-all shadow-xs">
                    ...
                    <div>
                      <p className="text-sm text-slate-700 dark:text-zinc-200 font-medium">
                        <strong className="text-slate-900 dark:text-white">Dynamic Editorial & News Engine:</strong> Architecting modular publishing flows with granular Role-Based Access Control (RBAC) separating Admin controls, Editor review workflows, and Author content drafts.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3 p-3.5 rounded-2xl bg-slate-50 dark:bg-slate-950/40 border border-slate-200/80 dark:border-white/5 hover:border-cyan-500/30 transition-all shadow-xs">
                    ...
                    <div>
                      <p className="text-sm text-slate-700 dark:text-zinc-200 font-medium">
                        <strong className="text-slate-900 dark:text-white">High-Throughput Content Delivery:</strong> Leveraging Next.js App Router for Server-Side Rendering (SSR) and Incremental Static Regeneration (ISR) ensuring sub-second rendering latency and breaking-news SEO indexing.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3 p-3.5 rounded-2xl bg-slate-50 dark:bg-slate-950/40 border border-slate-200/80 dark:border-white/5 hover:border-cyan-500/30 transition-all shadow-xs">
                    ...
                    <div>
                      <p className="text-sm text-slate-700 dark:text-zinc-200 font-medium">
                        <strong className="text-slate-900 dark:text-white">Resilient Backend Architecture:</strong> Engineering Node.js/Express REST API endpoints optimized with MongoDB aggregation pipelines for instant article search, category filtering, and real-time trending metrics.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3 p-3.5 rounded-2xl bg-slate-50 dark:bg-slate-950/40 border border-slate-200/80 dark:border-white/5 hover:border-cyan-500/30 transition-all shadow-xs">
                    ...
                    <div>
                      <p className="text-sm text-slate-700 dark:text-zinc-200 font-medium">
                        <strong className="text-slate-900 dark:text-white">Modern Reader Experience:</strong> Crafting responsive, accessible UI layouts with interactive reading modes, rich media embeds, and clean glassmorphism dark mode styling.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              {/* Tech Stack Chips */}
              <div className="pt-2">
                <div className="text-xs font-mono uppercase tracking-wider text-slate-500 dark:text-zinc-400 mb-3 font-bold">
                  PRODUCTION STACK USED
                </div>
                <div className="flex flex-wrap items-center gap-2">
                  <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-slate-100 dark:bg-slate-950 border border-slate-200 dark:border-white/10 text-xs font-semibold text-slate-800 dark:text-zinc-200 shadow-xs">
                    <SiNextdotjs className="w-3.5 h-3.5 text-slate-900 dark:text-cyan-400" />
                    <span>Next.js App Router</span>
                  </div>
                  <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-slate-100 dark:bg-slate-950 border border-slate-200 dark:border-white/10 text-xs font-semibold text-slate-800 dark:text-zinc-200 shadow-xs">
                    <SiTypescript className="w-3.5 h-3.5 text-sky-600 dark:text-sky-400" />
                    <span>TypeScript</span>
                  </div>
                  <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-slate-100 dark:bg-slate-950 border border-slate-200 dark:border-white/10 text-xs font-semibold text-slate-800 dark:text-zinc-200 shadow-xs">
                    <SiNodedotjs className="w-3.5 h-3.5 text-emerald-600 dark:text-emerald-400" />
                    <span>Node.js</span>
                  </div>
                  <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-slate-100 dark:bg-slate-950 border border-slate-200 dark:border-white/10 text-xs font-semibold text-slate-800 dark:text-zinc-200 shadow-xs">
                    <SiExpress className="w-3.5 h-3.5 text-slate-700 dark:text-zinc-300" />
                    <span>Express.js</span>
                  </div>
                  <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-slate-100 dark:bg-slate-950 border border-slate-200 dark:border-white/10 text-xs font-semibold text-slate-800 dark:text-zinc-200 shadow-xs">
                    <SiMongodb className="w-3.5 h-3.5 text-emerald-600 dark:text-emerald-500" />
                    <span>MongoDB Atlas</span>
                  </div>
                  <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-slate-100 dark:bg-slate-950 border border-slate-200 dark:border-white/10 text-xs font-semibold text-slate-800 dark:text-zinc-200 shadow-xs">
                    <SiTailwindcss className="w-3.5 h-3.5 text-cyan-600 dark:text-cyan-400" />
            ...
            <div className="lg:col-span-5 w-full">
              <div className="rounded-2xl bg-slate-950 border border-slate-800 dark:border-zinc-800 shadow-2xl overflow-hidden font-mono text-xs">
                {/* HUD Header Bar & Tabs */}
